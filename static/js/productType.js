...
class ProductsType{
    ...
    renders() {
      ...
      ` 
                ...
                <div class="bottom">
                  <a href="http://bestshop.pythonanywhere.com/product/detail/${this.id}" class="details">${this.product_name}</a>
                  <div class="price">
...
//Fruit Types
 axios.get('http://bestshop.pythonanywhere.com/api/product/all?category=Fruit')
 .then((data) => {
...
//Vegetable Types
 axios.get('http://bestshop.pythonanywhere.com/api/product/all?category=Vegetable')
 .then((data) => {
   if(data.status === 200){
     const cardshop = document.querySelector('.cardshop');
 ...
 axios.get('http://bestshop.pythonanywhere.com/api/product/all?category=Pizza')
 .then((data) => {
   if(data.status === 200){
      const cardshop = document.querySelector('.cardshop');
       data.data.forEach((item)=>{
 ...
 axios.get('http://bestshop.pythonanywhere.com/api/product/all?category=Food')
 .then((data) => {
   if(data.status === 200){
      const cardshop = document.querySelector('.cardshop');
...
console.log(document.querySelector('#fish'))
  axios.get('http://bestshop.pythonanywhere.com/api/product/all?category=Fish')
  .then((data) => {
    if(data.status === 200){
       const cardshop = document.querySelector('.cardshop');
...
console.log(document.querySelector('#fish'))
  axios.get('http://bestshop.pythonanywhere.com/api/product/all?category=Pilav')
  .then((data) => {
    if(data.status === 200){
       const cardshop = document.querySelector('.cardshop');
  ...
  // Ice cream
  console.log(document.querySelector('#fish'))
  axios.get('http://bestshop.pythonanywhere.com/api/product/all?category=Ice_cream')
  .then((data) => {
    if(data.status === 200){
       const cardshop = document.querySelector('.cardshop');
  ...
  // Drink
  console.log(document.querySelector('#fish'))
  axios.get('http://bestshop.pythonanywhere.com/api/product/all?category=Drink')
  .then((data) => {
    if(data.status === 200){
       const cardshop = document.querySelector('.cardshop');
